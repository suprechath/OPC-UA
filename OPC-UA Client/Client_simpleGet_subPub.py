...
if __name__ == "__main__":
    ...
    handler = SubHandler()
    sub = client.create_subscription(60, handler)

    # Subscribe to the nodes
    handle1 = sub.subscribe_data_change(m1_temp)
    handle2 = sub.subscribe_data_change(m1_pressure)
    handle3 = sub.subscribe_data_change(m1_speed)
    handle4 = sub.subscribe_data_change(m2_temp)
    handle5 = sub.subscribe_data_change(m2_pressure)
    handle6 = sub.subscribe_data_change(m2_speed)
